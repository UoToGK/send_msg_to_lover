...
def send_message(
    ...
    for k, v in config.items():
        if k[0:5] == "birth":
            # k = "args19"
            # if birthdays.get("args19"):
            #     k = "args20"
            birthdays[k] = v
    data = {
        "touser": "oroUy6Quw9We4TsrhruCKOnuAMys",
        "template_id": "bHYX13Cxpc4gpu3nMGqRRgWCYk7_8vnX5LTEZHUPrXw",
        # "url": "http://weixin.qq.com/download",
        "url": "https://bing.ioliu.cn/v1/rand?w=768&h=1024",
        "topcolor": "#FF0000",
        "data": {
            "args1": {"value": "{} {}".format(today, week), "color": get_color()},
            "args2": {"value": "地区:" + region_name, "color": get_color()},
            "args3": {"value": "天气状况:" + weather, "color": get_color()},
            "args4": {"value": "当前气温:" + temp, "color": get_color()},
            "args5": {"value": "风向: " + wind_dir, "color": get_color()},
            # "args6": {"value": chp, "color": get_color()},
            "args7": {"value": "体感温度:" + feelsLike, "color": get_color()},
            "args8": {"value": "风力等级:" + windScale, "color": get_color()},
            "args9": {"value": "最高气温:" + max_temp, "color": get_color()},
            "args10": {"value": "最低气温:" + min_temp, "color": get_color()},
            "args11": {"value": "日出时间:" + sunrise, "color": get_color()},
            "args12": {"value": "日落时间:" + sunset, "color": get_color()},
            "args13": {"value": "空气质量:" + category, "color": get_color()},
            "args14": {"value": "PM2.5: " + pm2p5, "color": get_color()},
            # "args15": {"value": "今日建议:" + proposal, "color": get_color()},
            "args16": {"value": f"我们已经认识{love_day}天啦~~~", "color": get_color()},
            # "args17": {"value": note_en, "color": get_color()},
            # "args18": {"value": note_ch, "color": get_color()},
            "args19": {"value": "朱嫒橙你好呀~", "color": get_color()},
        },
    }
...
if __name__ == "__main__":
    ...
    try:
        with open("bak.config", encoding="utf-8") as f:
            config = eval(f.read())
